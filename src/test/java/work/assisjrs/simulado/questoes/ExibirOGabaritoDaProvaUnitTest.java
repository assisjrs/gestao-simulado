...
public class ExibirOGabaritoDaProvaUnitTest {
    ...
    public void deve_retornar_uma_lista_vazia_de_questoes_caso_nao_tenha_questoes_para_um_determinada_prova() {
        ...
        assertThat(service.findGabarito(prova)).isEmpty();
    }
    ...
    public void deve_retornar_uma_lista_de_questoes_para_uma_determinada_prova() {
        ...
        when(repository.findEscolhasCertas(eq(questao))).thenReturn(new ArrayList<>());

        assertThat(service.findGabarito(prova)).isNotEmpty();
    }
}
